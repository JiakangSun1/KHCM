...
class MAE_ViT_MsLd(MAE_ViT_Baseline):
    ...
    def forward(
        ...
        if is_teacher:
            ...
            imgs, mask_ratio=mask_ratio, mask_seed=mask_seed, return_embeds=True, is_teacher=True
        ) 
        #     enc_emb_crop = super().forward(
        #     imgs_crop, mask_ratio=mask_ratio, mask_seed=mask_seed, return_embeds=True, is_teacher=True
        # )
            return enc_emb_orig
