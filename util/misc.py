...
def save_model(args, epoch, model, model_without_ddp, optimizer, loss_scaler, teacher=None, teacher_without_ddp=None):
...
def load_model(args, model_without_ddp, optimizer, loss_scaler, device=None, teacher_without_ddp=None):
    print("resume is ****")
    ...
    mse = model_without_ddp.load_state_dict(checkpoint["model"], strict=False)
